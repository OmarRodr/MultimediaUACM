...
public class Album extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
     //Modificar
        auxbtn.auxBtnGuardar("Album","idAlbum", "nombreA", "artistaA", "generoA", "estrenoA", "duracionA", "existenciaA", "imgAlbum");
     /*if (auxVista.validarFormulario()) {
        Connection con = UConnection.getConnection();
        String sql = "INSERT INTO Album Values('"+Integer.parseInt(txtId.getText())+"','"+txtAlbum.getText()+"','"+txtArtista.getText()+"','"+txtGenero.getText()+"',"
        +"'"+Integer.parseInt(txtEstreno.getText())+"','"+Integer.parseInt(txtExistencia.getText())+"','"+Float.parseFloat(txtDuracion.getText())+"')";   
        try {
