...
public class PrincipalUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(51, 255, 0,80));
        ...
        jScrollPane1.setBackground(new java.awt.Color(255, 255, 0,80));
    ...
    String c = (String) cbxTipo.getSelectedItem();
        if (validarFormulario()) {
         if (c == "Album"){
            if (auxVistas.existeMultimedia(c, "nombreA", txtBuscar) == 0) {
             JOptionPane.showMessageDialog(null, "Error....\nEl álbum buscado no existe."
                + "\nIntentalo nuevamente", "¡¡Advertencia!!",
        ...
        if (c == "Cancion"){  
         if (auxVistas.existeMultimedia(c, "nombreC", txtBuscar) == 0) {
        ...
        if (c == "Video"){
            if (auxVistas.existeMultimedia(c, "nombreV", txtBuscar) == 0) {
                JOptionPane.showMessageDialog(null, "Error....\nEl video buscado no existe."
                + "\nIntentalo nuevamente", "¡¡Advertencia!!",
                JOptionPane.INFORMATION_MESSAGE);
                txtBuscar.setText("");
            } else {
...
class FondoPanel extends JPanel
{
 ...
 public void paint(Graphics g){
  imagen = new ImageIcon(getClass().getResource(
          "/Imagenes/atardecer2.jpeg")).getImage();
