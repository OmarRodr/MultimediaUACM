...
public class Album extends javax.swing.JFrame {
    ...
    public Album() {
        ...
        lbImagen.setIcon(new ImageIcon(Album.class.getResource("/Recursos/al.png")));
        lbImagen.setBounds(0, -45,590,455);
     ...
     int v = JOptionPane.showConfirmDialog(this, "¿Estas seguro de salir de esta ventan?\n Si abandonas la ventana se perdera el proceso", "¡¡ADVERTENCIA!!", JOptionPane.YES_NO_OPTION);
        if (v == JOptionPane.YES_OPTION) {
            ...
            this.setVisible(false);
             ...
             JOptionPane.showMessageDialog(null,"Sigue con el registro de un nuevo álbum.","¡¡CONTINUAR!!",JOptionPane.INFORMATION_MESSAGE);
          }
