...
public class Video extends javax.swing.JFrame {
    ...
    if (auxVista.validarFormulario()) {
      try {
        ...
        String sql = "INSERT INTO Video (idVideo, nombreV, artistaV, generoV, estrenoV,"
                + " duracionV, ExistenciaV, imgVideo) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        ps.setFloat(7, Float.parseFloat(txtDuracion.getText()));
