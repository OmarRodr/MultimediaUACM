...
public class AuxiliarVistas extends javax.swing.JFrame{
   ...
   public final void eliminaMensaje(JTextField t){
    ...
    public int existeRegistro(JTextField txtUsuario, JTextField txtContrasena, String cad1, String cad2, String cad3 ) {
    try {
           PreparedStatement ps = null;
           ResultSet rs = null;
           Connection con = UConnection.getConnection();
           String sql = "SELECT COUNT(*) FROM "+cad1+" WHERE "+cad2+"=? and "+cad3+"=?";
    ...
    public boolean validarFormularioInicio() {
    boolean valido = true;
    ...
    if (!Validador.validaEntero(txtId.getText())) {
       valido = false;
       enviaMensaje("El nombre de usuario puede contener numeros enteros", txtId);
    } else {
