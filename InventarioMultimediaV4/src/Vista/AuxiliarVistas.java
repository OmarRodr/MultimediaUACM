...
public class AuxiliarVistas extends javax.swing.JFrame{
   ...
   JTextField txtNCanciones;
   JTextField txtDuracion;

    public AuxiliarVistas(JTextField txtId, JTextField txtNombre, JTextField txtArtista, JTextField txtGenero, JTextField txtEstreno, JTextField txtNCanciones, JTextField txtDuracion) {
        this.txtId = txtId;
        this.txtNombre = txtNombre;
        this.txtArtista = txtArtista;
        this.txtGenero = txtGenero;
        this.txtEstreno = txtEstreno;
        this.txtNCanciones = txtNCanciones;
        this.txtDuracion = txtDuracion;
    }
   public void eliminaMensaje(JTextField t){
           t.setBorder(b);
           t.setToolTipText(null);
    }
    public void enviaMensaje(String mensaje, JTextField t){
    ...
    if (!Validador.validaTexto(txtArtista.getText())) {
      valido = false;
      txtArtista.setText("");
      enviaMensaje("El nombre del artista o autor solo debe de contener caracteres alfabeticos", txtArtista);  
    } else {
    ...
    if (!Validador.validaTexto(txtNombre.getText())) {
       valido = false;
       txtNombre.setText("");
       enviaMensaje("El nombre del álbum o video solo debe de contener caracteres alfabeticos ", txtNombre);
    } else {
    ...
    if (!Validador.validaTexto(txtGenero.getText())) {
       valido = false;
       txtGenero.setText("");
       enviaMensaje("El genero solo debe de contener caracteres alfabeticos", txtGenero);
    } else {
    ...
    if (!Validador.validaEntero(txtNCanciones.getText())) {
       valido = false;
       txtNCanciones.setText("");
       enviaMensaje("Esta sección solo permite caracteres numericos enteros", txtNCanciones);
    } else {
    ...
    if (!Validador.validaDuracion(txtDuracion.getText())) {
       valido = false;
       txtDuracion.setText("");
       enviaMensaje("El tiempo de duracion solo debe de contener caracteres numericos seguidos de un punto y nuevamente caracteres numericos", txtDuracion);
    } else {
        eliminaMensaje(txtDuracion);
      }  
    return valido;
    } 
    public void salirVista(){
