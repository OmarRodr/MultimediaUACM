...
public class ActualizarCancion extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        auxbtn.btnGuardaActualizacionC(txtActualizar,"Cancion","idCancion", "nombreC", "artistaC",
    ...
    auxbtn.btnActualizaC(txtActualizar,"Cancion","idCancion", "nombreC", "artistaC",
               "generoC", "estrenoC", "idAlbum", "duracionC", "imgCancion",
               "audCancion");    
       /*try{
            ...
            Connection con = UConnection.getConnection();
            String sql = "SELECT   idCancion,nombreC,artistaC,generoC,estrenoC,idAlbum,duracionC,imgCancion,audCancion FROM Cancion WHERE idCancion=?";
            ...
            txtIdAlbum.setText(rs.getString(7));
            txtDuracion.setText(Float.toString(rs.getFloat(6)));
